...
nav_order: 3
permalink: /docs/05-financial-officer/regular-tasks/annual/
---
...
{: .missing-invoice }
If UBC has not issued the Commercial Rent (January) or Services Levy (July)
invoice by the last day of that month, (1) send weekly reminders to UBC
Treasury until the invoice is received, (2) notify the HFC, and (3) notify Council. Once the invoice
